...
public:
    ...
    // relinKeys: 암호문끼리 곱셈 후 크기가 커지는 것을 원래대로 줄이는 키
...
private:
    ...
    seal::RelinKeys relin_keys_;  // 곱셈 후 Relinearization, 서버에 전달
